...
import com.tts.MyTwitterProject.*;
...
public class TweetController {
	 ...
	 public String getTweetsByTag(@PathVariable(value= "tag") String tag, Model mode) {
		 List<TweeDisplay> tweets = tweetService.findAllWithTag(tag);
		 model.addAttribute("tweetList", tweets);
